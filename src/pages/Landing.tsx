...
const FALLBACK_HERO = {
  ...
  title2: 'برنده شو.',
  desc: 'GAMEVERSE — ۲۰ سیستم RTX 4070، سالن VIP، مسابقات هفتگی با جایزه نقدی. پیشبینی امن روی مسابقات داخلی با کیف پول تومانی و تسویه آنی.',
  stats: [
    ...
    <>
      <section className="hero" style={{ padding: '56px 0 36px' }}>
        <div className="container hero-grid">
          <div>
            <span className="badge" style={{marginBottom:"1rem"}}>{hero.badge}</span>
            ...
            <div style={{ display: 'flex', gap: 18, marginTop: 22, color: 'var(--muted)', fontSize: 13, flexWrap: 'wrap' }}>
              <span>⏱ ۲۴/۷ باز</span><span>📍 مجیدیه جنوبی</span><span>⭐ ۴.۸ / ۵۰۰+ نظر</span>
            </div>
          </div>
      ...
      <section id="contact" style={{ padding: '10px 0 28px' }}>
        <div className="container contact-grid">
          ...
          <div className="card" style={{ padding: 16, display: 'grid', placeItems: 'center', color: 'var(--muted)', fontSize: 13 }}>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d239.8251956527834!2d51.46632408617925!3d35.74021545044254!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3f8e03004545b533%3A0x77082a3fbb4c68ff!2z2YbbjNqp2KfZhiDahtmI2Kg!5e1!3m2!1sfa!2s!4v1789294194579!5m2!1sfa!2s" ></iframe>
          </div>
        </div>
      </section>
    </>
